...
def main():
    ...
    if flask.request.method == 'POST':
        ...
        y_pred = loaded_model.predict([[angle, step, patch_density, density, elasticity_module, hardener_quantity, epoxy_group,
                                        temperature, surface_density, elasticity_module2, tensile_strength, resin_consumption]])
